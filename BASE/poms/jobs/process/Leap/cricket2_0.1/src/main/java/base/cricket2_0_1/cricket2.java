...
/**
 * Job: cricket2 Purpose: cricket<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class cricket2 implements TalendJob {
	...
	private final String jobName = "cricket2";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(cricket2.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row6Struct implements routines.system.IPersistableComparableLookupRow<row6Struct> {
		final static byte[] commonByteArrayLock_BASE_cricket2 = new byte[0];
		static byte[] commonByteArray_BASE_cricket2 = new byte[0];
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.Team_Name == null) ? 0 : this.Team_Name.hashCode());
		...
		public boolean equals(Object obj) {
			...
			} else if (!this.Team_Name.equals(other.Team_Name))
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_BASE_cricket2.length) {
					if (length < 1024 && commonByteArray_BASE_cricket2.length == 0) {
						commonByteArray_BASE_cricket2 = new byte[1024];
					} else {
						commonByteArray_BASE_cricket2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_BASE_cricket2, 0, length);
				strReturn = new String(commonByteArray_BASE_cricket2, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_BASE_cricket2, 0, length);
				strReturn = new String(commonByteArray_BASE_cricket2, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readKeysData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_BASE_cricket2) {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.Team_SK = readInteger(dis, ois);
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.Team_SK = readInteger(dis, objectIn);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeInteger(this.Team_SK, dos, oos);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeInteger(this.Team_SK, dos, objectOut);
		...
		public int compareTo(row6Struct other) {
			...
			returnValue = checkNullsAndCompare(this.Team_Name, other.Team_Name);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_3.addRow(new String[] { "Team_SK", "Team_Id", "Team_Name", });
						...
						try {
							...
							if (rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])) {// empty
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									if (rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											row2.Team_SK = ParserUtils.parseTo_Integer(
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									if (rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											row2.Team_Id = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									row2.Team_Name = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
///////////////////////		
							...
							if (row2.Team_SK != null) { //
								row_tLogRow_3[0] = String.valueOf(row2.Team_SK);

							} //

							if (row2.Team_Id != null) { //
								row_tLogRow_3[1] = String.valueOf(row2.Team_Id);

							} //

							if (row2.Team_Name != null) { //
								row_tLogRow_3[2] = String.valueOf(row2.Team_Name);
...
///////////////////////    			
							...
							row6_HashRow.Team_SK = row6.Team_SK;
							row6_HashRow.Team_Id = row6.Team_Id;
							row6_HashRow.Team_Name = row6.Team_Name;
					...
					while (limittFileInputDelimited_2 != 0 && csvReadertFileInputDelimited_2 != null
						...
						try {
							...
							if (rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])) {// empty
								...
								row1.Toss_Winner = null;

								row1.match_winner = null;

								row1.Toss_Name = null;

								row1.Win_Type = null;

								row1.Outcome_Type = null;

								row1.ManOfMach = null;

								row1.Win_Margin = null;
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									if (rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.Match_SK = ParserUtils.parseTo_Integer(
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.Team1 = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.Team2 = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.match_date = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									if (rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.Season_Year = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.Venue_Name = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.City_Name = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.Country_Name = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.Toss_Winner = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.match_winner = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.Toss_Name = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.Win_Type = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.Outcome_Type = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.ManOfMach = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.Win_Margin = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									if (rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.Country_id = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
...
// Start of branch "row1"
						if (row1 != null) {
							...
							operation_finder_tAggregateRow_1.match_winner = row1.match_winner;
							...
							if (row1.match_id != null) { // G_OutMain_AggR_546
				...
				util_tLogRow_1.addRow(new String[] { "Team_Name", "count", "Team_Id", });
...
///////////////////////    			
				...
				class Util_tJoin_1 {
					...
					public boolean isJoined(row4Struct mainRow) {
						row6HashKey.Team_Name = mainRow.match_winner;
				...
				util_tLogRow_2.addRow(new String[] { "match_winner", "count", });
...
///////////////////////    			
				...
				for (AggOperationStruct_tAggregateRow_1 aggregated_row_tAggregateRow_1 : values_tAggregateRow_1) { // G_AggR_600
					...
					row4.match_winner = aggregated_row_tAggregateRow_1.match_winner;
...
///////////////////////		
					...
					if (row4.match_winner != null) { //
						row_tLogRow_2[0] = String.valueOf(row4.match_winner);

					} //

					if (row4.count != null) { //
						row_tLogRow_2[1] = String.valueOf(row4.count);
...
///////////////////////    			
					...
					row3 = new row3Struct();
					row3.count = row5.count;

					if (util_tJoin_1.isJoined(row5)) {
						row3.Team_Name = util_tJoin_1.lookupValue.Team_Name;
						row3.Team_Id = util_tJoin_1.lookupValue.Team_Id;
					}
...
///////////////////////		
						...
						if (row3.Team_Name != null) { //
							row_tLogRow_1[0] = String.valueOf(row3.Team_Name);

						} //

						if (row3.count != null) { //
							row_tLogRow_1[1] = String.valueOf(row3.count);

						} //

						if (row3.Team_Id != null) { //
							row_tLogRow_1[2] = String.valueOf(row3.Team_Id);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final cricket2 cricket2Class = new cricket2();

		int exitCode = cricket2Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = cricket2.class.getClassLoader()
					.getResourceAsStream("base/cricket2_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = cricket2.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : cricket2");
		}
...
/************************************************************************************************
 * 170040 characters generated by Talend Open Studio for Data Integration on the
 * March 20, 2023 at 2:41:13 PM EDT
 ************************************************************************************************/